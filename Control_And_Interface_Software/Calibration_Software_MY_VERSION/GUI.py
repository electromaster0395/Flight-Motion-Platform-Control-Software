from PyQt5.QtWidgets import QApplication, QMainWindow, QVBoxLayout, QWidget, QLabel, QSpinBox, QLineEdit, QComboBox, QPushButton, QFileDialog, QCheckBox
import sys
...
class CalibrationApp(QMainWindow):
    def __init__(self):
        ...
        # Add a checkbox to enable/disable CSV output
        self.output_csv_enabled = True  # Default: CSV saving is disabled
        self.checkbox_csv_output = QCheckBox("Enable CSV Output", self)
        self.checkbox_csv_output.setChecked(True)  # Default state

        # Add the checkbox to the UI layout
        layout.addWidget(self.checkbox_csv_output)
